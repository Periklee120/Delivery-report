...
if uploaded_files:
    ...
    add("ΕΥΟΣΜΟΣ, ΣΤΑΥΡΟΥΠΟΛΗ, ΕΥΚΑΡΠΙΑ, ΣΥΚΙΕΣ, ΝΕΑΠΟΛΗ, ΑΓΙΟΣ ΠΑΥΛΟΣ, ΠΟΛΙΧΝΗ, ΩΡΑΙΟΚΑΣΤΡΟ",[55438,56224,56225,56226,56238,56429,56430,56431,56437,56532,56533,56625,56626,56727,56728,57013])
    add("ΓΙΑΝΝΙΤΣΩΝ, ΑΜΠΕΛΟΚΗΠΟΙ, ΜΕΝΕΜΕΝΗ",[54627,54628,56121,56122,56123])
    add("ΚΟΡΔΕΛΙΟ, ΚΑΛΟΧΩΡΙ",[56334,57009])
    add("ΣΙΝΔΟΣ, ΙΩΝΙΑ, ΔΙΑΒΑΤΑ",[57008,57022,57400])
    add("ΧΩΡΙΑ",[57018,57200,54500])
