...
if uploaded_files:
    ...
    add("ΚΑΛΑΜΑΡΙΑ, ΝΤΕΠΩ, ΧΑΡΙΛΑΟΥ, ΑΝΑΛΗΨΗ, ΤΟΥΜΠΑ",[54248,54249,54250,54351,54352,54453,54454,55534,54646,54655,54638,54639,54641,54642,54643,54644,54645,55131,55132,55133,55134,55135])
